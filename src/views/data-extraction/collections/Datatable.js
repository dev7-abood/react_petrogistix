                        ...
                        <DropdownMenu right>
                            <DropdownItem tag='a' href='/' className='w-100'>
                                ...
                                <a target='_blank' download
                                   href={`${env.BACK_BASE_URL}${`/api_v1/access-file/?access_id=access_key_${userId}&file_path=${row.collection_path}`}`}><span
                                    className='align-middle'>Download</span></a>
                            </DropdownItem>
                            <Can have={['COLLECTION_DELETE']}>
                                <DropdownItem
                                    tag='a'
                                    href='/'
                                    className='w-100'
